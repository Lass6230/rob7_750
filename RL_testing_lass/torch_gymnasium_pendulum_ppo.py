...
try:
    env = gym.vector.make("Pendulum-v1", num_envs=4, asynchronous=False,render_mode="human") #render_mode="headless"    or  render_mode="human"
...
cfg_trainer = {"timesteps": 100000, "headless": True} #headless
