...
try:
    env = gym.vector.make("Pendulum-v1", num_envs=4, asynchronous=False,render_mode="human")
...
agent.load("./runs/torch/Pendulum/23-09-15_10-45-53-405098_PPO/checkpoints/best_agent.pt")

# configure and instantiate the RL trainer
cfg_trainer = {"timesteps": 10000, "headless": True} #headless
